    ...
    return (
        <div className="w-screen px-6">
            ...
            <div className="mb-5 w-full flex flex-wrap justify-center items-center border w-3/4 rounded-lg md:w-1/2 md:m-auto md:mt-5 md:mb-5">
                <a href="https://twitter.com/ben_duj" className="w-1/6 m-2 md:w-20">
                ...
                <a href="https://www.linkedin.com/in/benjamin-dujarrier/" className="w-1/6 m-2 md:w-20">
                ...
                <a href="https://github.com/BenjamQuill" className="w-1/6 m-2 md:w-20">
