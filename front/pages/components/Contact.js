...
export default function Contact() {
    return (
        <div className="w-screen px-6">
            <div className="">
                <div className="font-bold text-black text-xl text-center md:text-2xl">
                    Contactez moi
                </div>   
            </div>
            <div className="mb-5 w-full flex flex-wrap justify-center items-center border w-3/4 rounded-lg">
                <a href="https://twitter.com/ben_duj" class="w-1/6 m-2">
                ...
                <a href="https://www.linkedin.com/in/benjamin-dujarrier/" class="w-1/6 m-2">
                ...
                <a href="https://github.com/BenjamQuill" class="w-1/6 m-2">
