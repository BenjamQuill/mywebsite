    export default function Contact() {
        return (
            <form class="m-10 px-4 border rounded-lg m-5 w-1/2">
                <h1 className="text-3xl text-black-700 font-bold m-10 px-10">Contact me</h1>
            ...
            <div class="p-5 md:flex md:items-center">
                ...
                <div class="md:w-1/3">
                    <button class="shadow bg-green-600 hover:bg-green-400 focus:shadow-outline focus:outline-none text-black font-bold py-2 px-4 rounded" type="button">
                        Send !
                    </button>
                </div>
            </div>
